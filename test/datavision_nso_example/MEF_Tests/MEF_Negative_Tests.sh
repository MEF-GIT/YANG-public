...
config
!
mef-interfaces unis uni MMPOP1-ce8-Slot8-Port1 cen-id ACME-MEGAMART subscriber MegaMart admin-state-enabled false max-svc-frame-size 1600 max-evc-count 1 all-to-one-bundling-enabled true physical-layers links link ce8 GigabitEthernet0/1 ieee8023-phy ieee8023-1000BASE-SX
...
{ ncs_cli -u admin -C << EOF;
config
mef-services mef-service 1112345 sp-id Acme user-label NegativeTunnel svc-type epl evc evc-id EVC-Negative-Test evc-type point-to-point max-svc-frame-size 1600 max-uni-count 2 preserve-ce-vlan-id true cos-preserve-ce-vlan-id true
